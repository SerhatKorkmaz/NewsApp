...
class NewsAdapter : PagingDataAdapter<NewsData,NewsAdapter.NewsViewHolder>(NEWS_COMPARATOR) {
    ...
    class NewsViewHolder(private val binding: ItemNewsapiBinding) : RecyclerView.ViewHolder(binding.root){
